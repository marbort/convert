...
python ~/SHARED/GitHub/mio/convert/plot2d_reweight.py fes-rew_square_sparse.dat $CV1 $CV2 
python ~/SHARED/GitHub/mio/convert/plot_1D-2D_seaborn.py fes-rew_square_sparse.dat $CV1 $CV2 fes-rew_square_sparse_cv1.dat fes-rew_square_sparse_cv2.dat 150
