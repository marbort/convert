...
##REWEIGHTING###
python ~/SHARED/GitHub/mio/convert/plot2d_reweight.py fes-rew_square_sparse_walls.dat $CV1 $CV2 200
if  [ -f traj.xyz ]
then 
...
python ~/SHARED/GitHub/mio/convert/plot2d_reweight.py fes-rew_square_sparse_walls.dat $CV1 $CV2 200 $minima 
...
python ~/SHARED/GitHub/mio/convert/find_CV_struct.py --input colvar_trj --CVs $CV1 $CV2 --val minima.dat --tol 0.1 0.1
python ~/SHARED/GitHub/mio/convert/plot2d_reweight.py fes-stat_square_sparse_walls.dat $CV1 $CV2 200 $minima
