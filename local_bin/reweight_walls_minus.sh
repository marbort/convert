...
python ~/SHARED/GitHub/mio/convert/plot_1D-2D_seaborn.py fes-rew_square_sparse_walls.dat $CV1 $CV2 fes-rew_square_sparse_cv1_walls.dat fes-rew_square_sparse_cv2_walls.dat 120
