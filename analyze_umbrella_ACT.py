...
paths_DES=[root+mols+"/umbrella_30_200/window{}/umbrella_whole.xtc".format(i) for i in w_DES]
paths_ALL=[root+mols+"/umbrella_30_200/window{}/umbrella_whole.xtc".format(i) for i in w_all]
print(len(paths_ALL))
profile=root+mols+"/umbrella_30_200/profile.xvg"
...
u_single=[mda.Universe(root+"UMBRELLA_BIG_"+mols+"_MOD.parm7",i) for i in paths_ALL]
#%%
...
#%% ORIENTATION ALL 
orientation_ALL=[angle_with_axes("resname ACT and name C1","resname ACT and name O1",x) for x in u_single]
